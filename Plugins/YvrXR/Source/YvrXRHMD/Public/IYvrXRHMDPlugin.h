 ...
 * within this plugin.
 */
class YVRXRHMD_API IYvrXRHMDPlugin : public IHeadMountedDisplayModule
{
...
public:
	 ...
	 */
	static inline IYvrXRHMDPlugin& Get()
	{
		return FModuleManager::LoadModuleChecked< IYvrXRHMDPlugin >( "YvrXRHMD" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "YvrXRHMD" );
	}
